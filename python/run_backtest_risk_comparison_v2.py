...
对比测试：
1. 无风控的 EMA 交叉策略
2. 有风控的 EMA 交叉策略（止损 2%，止盈 5%，合理仓位）

改进：调整 trade_volume 为 0.4 BTC，使其符合 30% 仓位限制
"""
...
def run_backtest_without_risk():
    ...
    strategy_config = {
        ...
        'fast_period': 5,
        'slow_period': 20,
        'trade_volume': 0.4  # 0.4 BTC ≈ $28,000
    }
...
def main():
    """主函数"""
    logger.info("\n" + "=" * 80)
    logger.info("TTQuant Risk Management Backtest Comparison V2")
    logger.info("=" * 80)
